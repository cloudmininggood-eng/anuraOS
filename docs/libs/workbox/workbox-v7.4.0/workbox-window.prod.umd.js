!(function (n, t) {
	"object" == typeof exports && "undefined" != typeof module
		...
		: "function" == typeof define && define.amd
			...
			: t(
					((n =
						"undefined" != typeof globalThis ? globalThis : n || self).workbox =
						{}),
				);
})(this, function (n) {
	"use strict";
	...
	function e(n, t) {
		for (var r = 0; r < t.length; r++) {
			...
			((e.enumerable = e.enumerable || !1),
				...
				Object.defineProperty(n, u(e.key), e));
		}
	}
	function i(n, t) {
		var e =
			...
			return (
				...
				(e.cn = function () {
					var n = e.fn,
						t = n.installing;
					(e.tn > 0 ||
					!c(t.scriptURL, e.sn.toString()) ||
					performance.now() > e.un + 6e4
						? ((e.vn = t), n.removeEventListener("updatefound", e.cn))
						: ((e.hn = t), e.an.add(t), e.rn.resolve(t)),
						++e.tn,
						t.addEventListener("statechange", e.ln));
				}),
				(e.ln = function (n) {
					var t = e.fn,
						r = n.target,
						i = r.state,
						o = r === e.vn,
						u = { sw: r, isExternal: o, originalEvent: n };
					(!o && e.dn && (u.isUpdate = !0),
						e.dispatchEvent(new f(i, u)),
						"installed" === i
							? (e.mn = self.setTimeout(function () {
									"installed" === i &&
										t.waiting === r &&
										e.dispatchEvent(new f("waiting", u));
								}, 200))
							: "activating" === i &&
								(clearTimeout(e.mn), o || e.en.resolve(r)));
				}),
				(e.yn = function (n) {
					var t = e.hn,
				...
				(e.sn = t),
				(e.nn = r),
				navigator.serviceWorker.addEventListener("message", e.wn),
				e
			);
		}
		var i, u;
		((u = n),
			((i = r).prototype = Object.create(u.prototype)),
			(i.prototype.constructor = i),
			o(i, u));
		var v = r.prototype;
		return (
			(v.register = function (n) {
				...
				try {
					...
					return s(
						(function (n, t) {
							...
							function () {
								return (
									(e.dn = Boolean(navigator.serviceWorker.controller)),
									(e.gn = e.pn()),
									s(e.bn(), function (n) {
										((e.fn = n),
											e.gn &&
												...
												e.en.resolve(e.gn),
												e.on.resolve(e.gn),
												e.gn.addEventListener("statechange", e.ln, {
													once: !0,
												})));
										var t = e.fn.waiting;
										return (
			...
			(v.update = function () {
				try {
					return this.fn ? s(l(this.fn.update())) : s();
				} catch (n) {
					return Promise.reject(n);
				}
			}),
			...
			(v.messageSkipWaiting = function () {
				this.fn && this.fn.waiting && t(this.fn.waiting, h);
			}),
			(v.pn = function () {
		...
		(function () {
			...
			return (
				...
				(t.dispatchEvent = function (n) {
					n.target = this;
					for (var t, r = i(this.jn(n.type)); !(t = r()).done; ) {
						(0, t.value)(n);
					}
				}),
				(t.jn = function (n) {
