	...
	if (null != r) {
		...
		try {
			if (((u = (r = r.call(n)).next), 0 === t)) {
				...
				for (
					;
					!(c = (e = u.call(r)).done) && (a.push(e.value), a.length !== t);
					c = !0
				);
		} catch (n) {
			((l = !0), (o = n));
...
!(function (n, t) {
	...
	function r(n, r) {
		...
		return function (o, u) {
			return (function () {
				if (e) return e;
				var o = indexedDB.open(n);
				return (
					(o.onupgradeneeded = function () {
						return o.result.createObjectStore(r);
					}),
					(e = t(o)).then(
						function (n) {
							n.onclose = function () {
				...
				return u(n.transaction(r, o).objectStore(r));
			});
		};
	}
	var e;
	...
	((n.clear = function () {
		...
		(n.del = function (n) {
			return (
				...
				return (r.delete(n), t(r.transaction));
			});
		}),
		...
		(n.entries = function () {
			var n =
				arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : o();
			return n("readonly", function (r) {
				if (r.getAll && r.getAllKeys)
					return Promise.all([t(r.getAllKeys()), t(r.getAll())]).then(
						function (n) {
		...
		(n.keys = function () {
			return (
				...
				if (n.getAllKeys) return t(n.getAllKeys());
				var r = [];
				return u(n, function (n) {
					return r.push(n.key);
				}).then(function () {
			...
			return (
				...
				return new Promise(function (o, u) {
					e.get(n).onsuccess = function () {
						try {
							(e.put(r(this.result), n), o(t(e.transaction)));
						} catch (n) {
							u(n);
						}
					};
		...
		(n.values = function () {
			return (
				...
				if (n.getAll) return t(n.getAll());
				var r = [];
				return u(n, function (n) {
					return r.push(n.value);
				}).then(function () {
					return r;
				});
			});
