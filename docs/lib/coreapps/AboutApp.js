		...
		h(
			...
			h(
				...
				$if(
					...
					h("p", null, "Anura is booting from OPFS."),
					h("p", null, "Anura OPFS boot disabled."),
				),
				h("br", null),
				h("br", null),
				h(
	...
	async open(args = []) {
		...
		if (fullscreenEasterEgg) {
			aboutview.content.appendChild(
				h("div", {
					style:
						"background: url(/assets/images/idol.gif); width: 100%; height: 100%; background-size: contain; background-repeat: no-repeat;",
				}),
			);
		} else {
