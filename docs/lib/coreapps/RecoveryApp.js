			...
			h(
				...
				h(
					"button",
					{
						...
						title:
							"Reset your Anura install to factory settings. This will delete all of your data.",
						"on:click": async () => {
							if (
				...
				$if(
					...
					h(
						"button",
						{
							...
							class: "matter-button-contained",
							title:
								"Clear the service worker cache. This requires an internet connection on your next boot.",
							"on:click": () => {
