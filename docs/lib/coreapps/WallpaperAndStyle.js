			...
			$if(
				...
				h(
					...
					h(
						...
						h(
							"div",
							{ className: "current-wallpaper-attributes" },
							h(
								"h5",
								{ class: "curr-wallpaper-text", color: "gray" },
								"Current Wallpaper",
							),
							h(
								"h3",
								{ class: "curr-wallpaper-name", color: "white" },
					...
					await this.wallpaperList().then((wallpaperJSON) => {
						const wallpaperList = h(
							"div",
							{ id: "wallpaper-list", class: "wallpaper-list-container" },
							h(
								"div",
								{
								...
								h(
									"h5",
									{ class: "wallpaper-list-item-name", color: "white" },
									"Upload new",
								),
							),
						);
