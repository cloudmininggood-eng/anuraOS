			...
			elm: h(
				...
				h(
					...
					h(
						...
						h(
							"button",
							{ "on:click": () => this.nextStep(), class: "preferredButton" },
							"Get Started",
						),
					),
				),
						...
						h(
							...
							h(
								...
								$if(
									...
									h("span", null, "Next"),
									h("span", null, h("span", null, "Finish")),
								),
								$if(
									use(this.state.v86Enabled),
									h(
