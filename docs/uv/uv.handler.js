(() => {
	...
	function g(o) {
		...
		let c = o.document ? a.node.baseURI.get.call(o.document) : o.location.href,
			S = e.sourceUrl(c);
		(a.nativeMethods.defineProperty(e.meta, "base", {
			get() {
				return o.document
					? (a.node.baseURI.get.call(o.document) !== c &&
							((c = a.node.baseURI.get.call(o.document)), (S = e.sourceUrl(c))),
						S)
					: e.meta.url.href;
			},
		}),
			...
			a.element.hookProperty([x, O, L, $], "href", {
			...
			a.element.hookProperty([_, U, v, d, y, M, j, u, H, E], "src", {
				get: (t, r) => e.sourceUrl(t.call(r)),
				set: (t, r, [l]) => {
					if (
			...
			a.element.hookProperty([T], "action", {
				get: (t, r) => e.sourceUrl(t.call(r)),
				set: (t, r, [l]) => {
					(a.element.setAttribute.call(
						r,
		...
		if (
			...
			a.websocket.on("websocket", async (t) => {
				...
				((r.Origin = e.meta.url.origin),
					...
					t.respondWith(
						b.createWebSocket(t.data.args[0], t.data.args[1], t.target, r),
					));
			}),
						...
						if (!l[i + "modifiedStyle"])
							for (let s of a.style.urlProps)
								(a.nativeMethods.defineProperty(l, s, {
									...
									configurable: !0,
									get() {
										let m = a.style.getPropertyValue.call(this, s) || "";
										return e.sourceCSS(m, { context: "value", ...e.meta });
									},
									set(m) {
										a.style.setProperty.call(
											this,
											a.style.propToDashed[s] || s,
											e.rewriteCSS(m, { context: "value", ...e.meta }),
										);
									},
								}),
		...
		(a.style.on("setCssText", (t) => {
			...
			a.nativeMethods.defineProperty(o.Object.prototype, p, {
				get: () => e,
				enumerable: !1,
			}),
