	...
	var c = We((Je, P) => {
		...
		l.prototype.emit = function (e) {
			...
			if (typeof u == "function") W(u, this, r);
				...
				for (var d = u.length, v = z(u, d), t = 0; t < d; ++t) W(v[t], this, r);
			return !0;
		};
		function B(a, e, r, t) {
			var n, i, o;
		...
		function Xe(a, e) {
			return new Promise(function (r, t) {
				...
				(J(a, e, i, { once: !0 }), e !== "error" && Qe(a, n, { once: !0 }));
			});
		}
		function Qe(a, e, r) {
			...
			overrideCreateTreeWalker() {
				this.ctx.override(this.docProto, "createTreeWalker", (e, r, t) => {
					...
					let [n, i = 4294967295, o, h] = t,
						u = new s(
							{ root: n, show: i, filter: o, expandEntityReferences: h },
							e,
							r,
						);
					return (
			...
			overrideOpen() {
				this.ctx.override(this.xhrProto, "open", (e, r, t) => {
					...
					let [n, i, o = !0, h = null, u = null] = t,
						d = new s(
							{ method: n, input: i, async: o, user: h, password: u },
							e,
							r,
						);
					return (
											...
											default:
												{
													...
													((h[i] = o), (n.location.href = r(h.href)));
												}
												break;
										}
									}
				...
				return (
					...
					"replace" in this.location &&
						this.ctx.nativeMethods.defineProperty(t, "replace", {
							value: this.ctx.wrap(this.location, "assign", (i, o, h) => {
								((!h.length || o !== t) && i.call(o), (o = this.location));
								let [u] = h,
									d = new URL(u, t.href);
								return i.call(o === t ? this.location : o, r(d.href));
							}),
							writable: !1,
							enumerable: !0,
						}),
	...
	var R = class extends Pe.default {
			...
			wrapPostMessage(e, r, t = !1) {
				return this.ctx.wrap(e, r, (n, i, o) => {
					...
					let v = new s(
						{ message: h, origin: u, transfer: d, worker: this.ctx.worker },
						n,
						e,
					);
					return (
