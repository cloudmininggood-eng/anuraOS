!(function (e, t) {
	"object" == typeof exports && "undefined" != typeof module
		...
		: "function" == typeof define && define.amd
			...
			: t(
					((e =
						"undefined" != typeof globalThis ? globalThis : e || self).Comlink =
						{}),
				);
})(this, function (e) {
	"use strict";
	...
	function c(e, t = globalThis, n = ["*"]) {
		(t.addEventListener("message", function r(s) {
			...
			const { id: i, type: l, path: p } = Object.assign({ path: [] }, s.data),
				f = (s.data.argumentList || []).map(w);
			let d;
			try {
			...
			Promise.resolve(d)
				...
				.then((n) => {
					const [o, s] = v(n);
					(t.postMessage(Object.assign(Object.assign({}, o), { id: i }), s),
						"RELEASE" === l &&
				...
				.catch((e) => {
					...
					t.postMessage(Object.assign(Object.assign({}, n), { id: i }), r);
				});
		}),
			t.start && t.start());
	}
	...
	function f(e) {
		return k(e, new Map(), { type: "RELEASE" }).then(() => {
			u(e);
		});
	}
	const d = new WeakMap(),
		...
		const i = new Proxy(o, {
			...
			set(n, r, o) {
				...
				return k(
					e,
					t,
					{ type: "SET", path: [...a, r].map((e) => e.toString()), value: i },
					c,
				).then(w);
			},
			apply(r, o, i) {
				...
				if (c === n) return k(e, t, { type: "ENDPOINT" }).then(w);
				if ("bind" === c) return m(e, t, a.slice(0, -1));
				const [u, l] = y(i);
				return k(
					e,
					t,
					{ type: "APPLY", path: a.map((e) => e.toString()), argumentList: u },
					l,
				).then(w);
			},
			construct(n, r) {
	...
	((e.createEndpoint = n),
		...
		(e.releaseProxy = r),
		(e.transfer = E),
		(e.transferHandlers = i),
		(e.windowEndpoint = function (e, t = globalThis, n = "*") {
			return {
