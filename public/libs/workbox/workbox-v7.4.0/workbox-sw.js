!(function () {
	...
	self.workbox = new (class {
		...
		setConfig(t = {}) {
			...
			(Object.assign(this.t, t), (this.o = this.t.debug ? "dev" : "prod"));
		}
		loadModule(t) {
			const e = this.h(t);
			try {
				(importScripts(e), (this.i = !0));
			} catch (s) {
		...
		h(t) {
			...
			let e = ["https://storage.googleapis.com/workbox-cdn/releases/7.4.0"];
			const s = `${t}.${this.o}.js`,
