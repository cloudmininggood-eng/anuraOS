...
function r(n, t) {
	for (var r = 0; r < t.length; r++) {
		...
		((e.enumerable = e.enumerable || !1),
			...
			Object.defineProperty(n, o(e.key), e));
	}
}
function e(n, r) {
	var e =
...
var l = (function (t) {
	function e(n, r) {
		...
		return (
			...
			(e.ln = function (n) {
				...
				(!o && e.mn && (u.isUpdate = !0),
					e.dispatchEvent(new c(i, u)),
					"installed" === i
						? (e.wn = self.setTimeout(function () {
								"installed" === i &&
									t.waiting === r &&
									e.dispatchEvent(new c("waiting", u));
							}, 200))
						: "activating" === i && (clearTimeout(e.wn), o || e.en.resolve(r)));
			}),
			(e.yn = function (n) {
				var t = e.hn,
	...
	var o, s;
	((s = t),
		((o = e).prototype = Object.create(s.prototype)),
								...
								f(e.bn(), function (n) {
									((e.fn = n),
										e.dn &&
											...
											e.en.resolve(e.dn),
											e.on.resolve(e.dn),
											e.dn.addEventListener("statechange", e.ln, {
												once: !0,
											})));
									var t = e.fn.waiting;
									return (
	...
	(function () {
		...
		return (
			...
			(t.dispatchEvent = function (n) {
				n.target = this;
				for (var t, r = e(this.jn(n.type)); !(t = r()).done; ) {
					(0, t.value)(n);
				}
			}),
			(t.jn = function (n) {
