					...
					if (catchHandler) {
						{
							...
							logger_js.logger.groupCollapsed(
								`Error thrown when responding to: ` +
									` ${getFriendlyURL_js.getFriendlyURL(url)}. Falling back to route's Catch Handler.`,
							);
					...
					if (this._catchHandler) {
						{
							...
							logger_js.logger.groupCollapsed(
								`Error thrown when responding to: ` +
									` ${getFriendlyURL_js.getFriendlyURL(url)}. Falling back to global Catch Handler.`,
							);
							logger_js.logger.error(`Error thrown by:`, route);
							logger_js.logger.error(err);
							logger_js.logger.groupEnd();
				...
				if (matchResult) {
					{
						...
						if (matchResult instanceof Promise) {
							logger_js.logger.warn(
								`While routing ${getFriendlyURL_js.getFriendlyURL(url)}, an async ` +
