...
class QuickSettings {
	...
	async init() {
				...
				h(
					...
					h(
						...
						h(
							"span",
							{ class: ["material-symbols-outlined"] },
							use(anura.platform.state.fullscreen, (fullscreen) =>
						...
						for (let i = 0; i < pinnedSettings.length; i++) {
							settingsElements.push(
								h(
									...
									{
										class: "pinnedSetting",
										title: this.state.pinnedSettings[i].description,
										"on:click": () => {
											anura.settings.set(
											...
											this.state.pinnedSettings[i].value = anura.settings.get(
												this.state.pinnedSettings[i].registry,
											);
											this.state.pinnedSettings = pinnedSettings;
											if (this.state.pinnedSettings[i].onChange) {
												new Function(
													"value",
													this.state.pinnedSettings[i].onChange,
									...
									h(
										...
										h(
											"span",
											{ class: "material-symbols-outlined" },
											this.state.pinnedSettings[i].icon || "settings",
										),
									),
									h(
										"div",
		...
		this.notificationCenterElement = h(
			Panel,
			{
				class: [
					this.transition,
			...
			h(
				...
				use(anura.notifications.state.notifications, (notifications) =>
