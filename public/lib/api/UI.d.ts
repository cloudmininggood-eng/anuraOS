...
declare class AnuraUI {
	 ...
	 */
	get<TProps extends object, TPrivate extends object, TPublic extends object>(
		name: string,
	): Promise<Component<TProps, TPrivate, TPublic>>;
	/**
	 ...
	 * ```
	 */
	use<TProps extends object, TPrivate extends object, TPublic extends object>(
